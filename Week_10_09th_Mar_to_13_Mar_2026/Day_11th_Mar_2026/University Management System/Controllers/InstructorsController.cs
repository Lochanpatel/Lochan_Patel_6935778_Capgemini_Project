...
namespace University_Management_System.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        {
            var universityContext = _context.Instructors.Include(i => i.Department);
        ...
        public async Task<IActionResult> Create([Bind("InstructorId,Name,DepartmentId")] Instructor instructor)
        {
            ...
            ViewData["DepartmentId"] = new SelectList(_context.Departments, "DepartmentId", "DepartmentId", instructor.DepartmentId);
            return View(instructor);
        }
